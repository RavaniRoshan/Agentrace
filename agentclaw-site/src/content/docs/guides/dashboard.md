...
The AgentTrace dashboard is a live web interface that shows all your agent runs in real-time. No configuration required — it automatically discovers traces as your agents run.
...
**Dashboard shows "Cannot connect to AgentTrace server"**
