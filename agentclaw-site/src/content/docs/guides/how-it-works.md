...
<svg width="900" height="520" viewBox="0 0 900 520" xmlns="http://www.w3.org/2000/svg">
  ...
  <text class="label" x="450" y="265">~/.agentclaw/traces/</text>
  ...
  <text class="label small" x="450" y="400">localhost:7823 · npx agentclaw</text>
...
Each trace is saved as a JSON file in `~/.agentclaw/traces/<trace_id>.json` with this structure:
