...
AgentTrace automatically extracts token usage from various LLM providers:
...
If token information isn't available, AgentTrace estimates based on character count (4 chars ≈ 1 token).
