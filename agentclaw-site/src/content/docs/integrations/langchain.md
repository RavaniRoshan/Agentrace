---
title: LangChain
description: Using AgentTrace with LangChain.
---
...
```python
from agentclaw import trace, trace_llm, trace_tool, patch_langchain
...
AgentTrace is tested and compatible with LangChain version **0.1.0** and above. The auto-patch function works with:
...
1. AgentTrace wraps LangChain's core classes with tracing decorators
...
5. All trace data flows to the standard AgentTrace system and appears in the UI
