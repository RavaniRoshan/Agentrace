    ...
    starlight({
      ...
      social: [
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/ravaniroshan/agentclaw",
        },
      ],
      ...
      head: [
        ...
        },
        {
          ...
          attrs: {
            property: "og:image",
            content: "https://agentclaw.dev/og.png"
          },
        },
        {
          tag: "meta",
        ...
        },
        {
          ...
          attrs: {
            name: "twitter:title",
            content: "AgentClaw — Visual debugger for AI agents",
          },
        },
        {
          tag: "meta",
          attrs: {
            ...
            content: "Your agent ran 15 steps. Something broke at step 9. AgentClaw shows you exactly what happened.",
          },
        },
        {
          tag: "link",
        ...
        },
        {
          ...
          content: JSON.stringify({
            ...
            codeRepository: "https://github.com/ravaniroshan/agentclaw",
